...
class ApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create application" do
    assert_difference('Application.count') do
      post applications_url, params: { application: { name: @application.name, state: @application.state } }
    end
  ...
  test "should update application" do
    patch application_url(@application), params: { application: { name: @application.name, state: @application.state } }
