...
class IncidentsTest < ApplicationSystemTestCase
  ...
  test "creating a Incident" do
    ...
    fill_in "Area", with: @incident.area_id
    fill_in "Criticality", with: @incident.criticality_id
    fill_in "Description", with: @incident.description
    check "State" if @incident.state
    fill_in "User", with: @incident.user_id
    fill_in "Userapplication", with: @incident.userapplication_id
